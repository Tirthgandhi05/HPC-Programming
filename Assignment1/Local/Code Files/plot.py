...
df = pd.read_csv(
    "./results_triad_local/avg_algo_times.csv",
...
plt.tight_layout()
plt.savefig("./results_triad_local/throughput_vs_problem_size.png")
plt.close()
...
plt.grid(True, which="both")
plt.tight_layout()
plt.savefig("./results_triad_local/bandwidth_vs_problem_size.png")
plt.close()
